...
<body>
	...
	<div class="size1 bg0 where1-parent">
		...
		<div class="size3 flex-col-sb flex-w p-l-75 p-r-75 p-t-45 p-b-45 respon1">
			<div id="logo"   style="background-image: url('theme/images/logo.jpg');">
			<div class=""></div>	
			</div>
			...
			<div class="p-t-50 p-b-60">
				...
				<form class="contact100-form validate-form" method="POST" action="/">
					...
					<div class="wrap-input100 m-b-10 validate-input" data-validate = "Phone is required">
							<input class="s2-txt1 placeholder0 input100" type="text" name="phone" placeholder="Your Phone Number" >
							<span class="focus-input100"></span>
						</div>
